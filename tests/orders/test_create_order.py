...
@allure.feature('Класс тестирования заказов.')
class TestCreateOrder:

    @allure.title('Создаем заказы с разными цветами,с двумя цветами, без цветов. Ожидаем ответ = 201, и получение Track ')
    ...
    @allure.title('Создаем курьера, заказ, проверяем что возвращется список заказов, удаляем курьера.')

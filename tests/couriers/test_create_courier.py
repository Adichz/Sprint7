...
class TestCreateCourier:
    ...
    @allure.step('Создаем курьера 2 раза. Ожидаем ответ = 409 и сообщение что Логин уже используется')
    ...
    @allure.step('Создаем курьера без Логина. Ожидаем ответ = 400 и сообщение что данных недостаточно')
    ...
    @allure.step('Создаем курьера без Пароля. Ожидаем ответ = 400 и сообщение что данных недостаточно')
